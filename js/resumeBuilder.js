...
var education = {
    "schools": [{
        ...
        "dates": "2006",
        "url": "http://www.au.edu.tw/main.php"
    }],
    "onlineCourses": [{
    ...
    display: function() {
        for (var edu = 0; edu < education.schools.length; edu++) {
            ...
            var formattedNameUrl = formattedName.replace("#", "http://www.au.edu.tw/main.php");
            var formattedDegree = HTMLschoolDegree.replace("%data%", education.schools[edu].degree);
            var formattedNameAndDegree = formattedNameUrl + formattedDegree;
...
var work = {
    ...
    display: function() {
        for (var i = 0; i < work.jobs.length; i++) {
            ...
            var formettedEmployerLocation = HTMLworkLocation.replace("%data%", work.jobs[i].location);
            $(".work-entry:last").append(formettedEmployerLocation);
        }
    }
};
